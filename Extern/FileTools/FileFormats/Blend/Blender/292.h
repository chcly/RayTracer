/*
    ...
    By    : tableDecompiler
    From  : 292.blend(BLENDER-v292)
    On    : Mon May 03 12:38:32 PM
...
namespace Blender
{
    ...
    struct NodeGeometryRotatePoints
    {
        char type;
        char space;
        char input_type_axis;
        char input_type_angle;
        char input_type_rotation;
        char _pad[3];
    };
    ...
    {
        void*              sbuffer;
        GPUBatch*          sbuffer_stroke_batch;
        GPUBatch*          sbuffer_fill_batch;
