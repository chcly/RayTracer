...
The following scene was rendered using the bAscii file.
...
`Viewer.exe Test01.bascii -r 0 -o ` [test.png](https://github.com/CharlesCarley/Raytracer/blob/master/Samples/Viewer/test.png)
